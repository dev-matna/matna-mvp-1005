    ...
    switch (currentScreen) {
      ...
      case 'explore':
        return <VideoFeed 
          ...
          onSharedVideoProcessed={() => setSharedVideoId(null)}
        />;
      case 'my':
        return <MyProfile 
    ...
    <ErrorBoundary>
      <AudioProvider>
        <div className="min-h-screen bg-gray-100 md:flex md:items-center md:justify-center">
          {/* Mobile Container */}
          <div className="w-full h-screen bg-white overflow-hidden relative md:max-w-sm md:mx-auto md:rounded-xl md:shadow-2xl">
            {/* VideoFeed 전용 풀스크린 레이아웃 */}
            {currentScreen === 'explore' ? (
              <>
                {/* VideoFeed - 전체 화면 독립 환경 */}
                <div 
